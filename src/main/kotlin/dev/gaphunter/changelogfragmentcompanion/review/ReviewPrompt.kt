package dev.gaphunter.changelogfragmentcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.changelogfragmentcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.changelogfragmentcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Changelog Fragment Companion"
    ...
    // https://plugins.jetbrains.com/plugin/<id>-changelog-fragment-companion/reviews once the
